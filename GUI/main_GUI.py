...
#    May 04, 2019 03:28:08 PM -0300  platform: Windows NT
...
class Main:
    def __init__(self, top=None):
        ...
        self.Frame1.place(relx=0.032, rely=0.026, relheight=0.641
                , relwidth=0.946)
        ...
        self.ButtonMO.place(relx=0.169, rely=0.245, height=44, width=197)
        self.ButtonMO.configure(activebackground="#ececec")
        self.ButtonMO.configure(activeforeground="#000000")
        ...
        self.ButtonMO.configure(width=197)

        self.ButtonMA = tk.Button(self.Frame1)
        self.ButtonMA.place(relx=0.169, rely=0.735, height=44, width=197)
        self.ButtonMA.configure(activebackground="#ececec")
        self.ButtonMA.configure(activeforeground="#000000")
        ...
        self.ButtonMT.place(relx=0.169, rely=0.49, height=44, width=197)
        self.ButtonMT.configure(activebackground="#ececec")
        self.ButtonMT.configure(activeforeground="#000000")
        ...
        self.Label2.place(relx=0.034, rely=0.041, height=33, width=269)
        self.Label2.configure(activebackground="#f9f9f9")
        self.Label2.configure(activeforeground="black")
        self.Label2.configure(background="#b5dcdd")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(font="-family {Segoe UI} -size 15 -weight bold -slant italic")
        ...
        self.Frame4.place(relx=0.032, rely=0.864, relheight=0.118
                , relwidth=0.946)
        ...
        self.Frame4.configure(width=295)

        self.fra44_lab46 = tk.Label(self.Frame4)
        self.fra44_lab46.place(relx=0.017, rely=0.222, height=23, width=276)
        ...
        self.fra44_lab46.configure(font="-family {Segoe UI} -size 10")
        ...
        self.Frame3.place(relx=0.032, rely=0.654, relheight=0.223
                , relwidth=0.946)
        ...
        self.ButtonCFG.place(relx=0.169, rely=0.235, height=44, width=197)
        self.ButtonCFG.configure(activebackground="#ececec")
        self.ButtonCFG.configure(activeforeground="#000000")
